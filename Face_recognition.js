#Face Recognition By Java Script , Face Api Js and Face Recognition

### This package is pretty much obsolete. I recommend you to switch to [face-api.js](https://github.com/kanishk192/face-api.js), which covers the same functionality as face-recognition.js in a nodejs as well as browser environment.
...
<p align="center">
<a href ="http://travis-ci.org/kanishk192/face-recognition.js"><img src="https://travis-ci.org/kanishk192/face-recognition.js.svg?branch=master" alt="Build Status" title="Build Status" /></a>
<a href ="https://ci.appveyor.com/project/kanishk192/face-recognition-js/branch/master"><img src="https://ci.appveyor.com/api/projects/status/a72kh7vd5hh09bso/branch/master?svg=true" alt="Build Status" title="Build Status" /></a>
<a href ="https://ci.appveyor.com/project/kanishk192/face-recognition-js/branch/master"><img src="https://slack.bri.im/badge.svg" alt="Slack" title="Slack" /></a>
</p>
...
Check out the TypeScript [examples](https://github.com/kanishk192/face-recognition.js/tree/master/examples/typed).


<a name="with-opencv4nodejs"></a>
# With opencv4nodejs

In case you need to do some image processing, you can also use this package with <a href="https://github.com/kanishk192/opencv4nodejs"><b>opencv4nodejs</b></a>. Also see <a href="https://github.com/kanishk192/face-recognition.js/tree/master/examples/opencv4nodejs"><b>examples</b></a> for using face-recognition.js with opencv4nodejs.
